//
//  FloatingTextFieldLabel.swift
//  spraytest
//
//  Created by Dominic O. Ighedosa on 2/18/21.
...
class FloatingLabelInput: UITextField {
    ...
    var floatingLabelColor: UIColor =
        UIColor(red: 169/256, green: 169/256, blue: 169/256, alpha: 1.0) {
        didSet {
    ...
    @IBInspectable
    var activeBorderColor: UIColor = UIColor(red: 105/256, green: 105/256, blue: 105/256, alpha: 1.0 )
    //UIColor.blue
    ...
    @objc func addFloatingLabel() {
        if self.text == "" {
            ...
            self.floatingLabel.bottomAnchor.constraint(equalTo: self.topAnchor, constant: +1).isActive = true // Place our label 10 pts above the text field
            self.placeholder = ""
        }
